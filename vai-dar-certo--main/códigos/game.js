...
class Game {
    ...
    init() {
        ...
        // The loops will process but update/render logic will wait for state changes
    ...
    update() {
        ...
        for (let i = this.projectiles.length - 1; i >= 0; i--) {
            ...
            proj.update(this.deltaTime, this.world);
            
            // Collision with player (if enemy projectile)
            if (!proj.isDead && proj.ownerType === 'enemy') {
