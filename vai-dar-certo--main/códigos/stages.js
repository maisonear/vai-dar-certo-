...
class StageSystem {
    constructor(game) {
        ...
        this.stages = {
            ...
            1: {
                ...
                description: 'Uma caverna infestada de goblins. O cheiro é horrível, alguém não tomou banho.',
                waves: 5,
            ...
            2: {
                ...
                description: 'Mortos-vivos vagueiam entre as lápides.',
                waves: 5,
            ...
            3: {
                ...
                description: 'Lobos ferozes protegem seu território.',
                waves: 5,
            ...
            5: {
                ...
                description: 'Criaturas venenosas habitam águas turvas.',
                waves: 5,
            ...
            8: {
                ...
                description: 'Antigos túmulos de reis esquecidos.',
                waves: 7,
            ...
            10: {
                ...
                description: 'Dragões menores e seus servos guardam o pico.',
                waves: 8,
                enemiesPerWave: { min: 4, max: 7 },
    ...
    completeStage(player) {
        ...
        if (this.game.lootSystem) {
            ...
            // Guaranteed Legendary for stage 12
            if (this.currentStage.rewards.guaranteedLegendary) {
                const legendaries = Object.values(ItemDatabase).filter(i => i.rarity === 'legendary' && i.type !== 'consumable');
                if (legendaries.length > 0) {
                    const randomLegendary = legendaries[Math.floor(Math.random() * legendaries.length)];
                    const item = createRandomItem(randomLegendary.id, this.currentStage.level);
                    if (item) this.game.inventorySystem.addItem(player, item);
                }
            }
        }
